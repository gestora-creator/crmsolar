-- UUID: migration-202603281530-fix-rpc-ambiguity
-- This migration fixes the "ambiguous column reference" error in find_or_create_grupo_economico RPC
-- The issue happens because the RETURNS TABLE definition didn't have AS aliases for the columns
